...
for i=1:length(idxsubgen2)
    ...
    %% Champions
    mlcpop2.champions = mlcpop.champions;
    
    if mlc_parameters.champions ~= 0
        for i_case = 1: mlc_parameters.nCases
            for i_champ = 1: mlc_parameters.champions
                
                champ_ind = mlcpop.champions(i_champ,i_case);
    ...
    %% elitism  (does not copy champios)
    if nargin < 4
        %create vector of non-champion individuals
        ...
        switch ops{opN}
            ...
            case 'mutation'
                ...
                while fail==1
                    ...
                    new_ind{opN}.cost_history = ones(1, mlc_parameters.nCases) * -1
            ...
            case 'crossover'
                ...
                while fail==1
                    ...
                    new_ind{opN}.cost_history = ones(1, mlc_parameters.nCases) * -1
                    new_ind2{opN}.cost_history = ones(1, mlc_parameters.nCases) * -1
