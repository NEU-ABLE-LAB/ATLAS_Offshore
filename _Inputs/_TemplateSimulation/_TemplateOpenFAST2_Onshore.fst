...
---------------------- INPUT FILES ---------------------------------------------
"_Template_ED_OnShore.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"_Template_SD_OnShore.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
