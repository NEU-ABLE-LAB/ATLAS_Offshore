...
---------------------- INPUT FILES ---------------------------------------------
"_Template_ED.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"_Template_IW.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"TestCase_AD15.05.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"_Template_SD.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"_Template_HD.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
